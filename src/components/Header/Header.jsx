...
import Logo from '../Logo/Logo.jsx'; // Importation du logo de l'application.
        ...
        <header>
          ...
          <nav>
            <ul className='nav__list--small'>
              <li><NavLink to="/" end className={({ isActive }) => (isActive ? 'activeLink' : '')}>Accueil</NavLink></li>
              <li><NavLink to="/about" className={({ isActive }) => (isActive ? 'activeLink' : '')}>À Propos</NavLink></li>
            </ul>
